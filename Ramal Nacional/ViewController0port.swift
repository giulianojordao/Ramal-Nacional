...
class ViewController0port: UIViewController,UIPageViewControllerDataSource {
    ...
    var languageZeroPort = String()
    
    @IBAction func recomecarButton(sender: AnyObject) {
    ...
    override func viewDidLoad() {
        ...
        self.pageImages = NSArray(objects: "bemvindo","port_01","port_02","port_03")
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if (segue.identifier == "tutorialPortugueseToPrincipal") {
